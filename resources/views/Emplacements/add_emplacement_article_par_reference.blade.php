                        ...
                        <div class = "col-12 col-lg-12">
                            <div class = "app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                                ...
                                <div class = "app-card-body px-4 w-100">
                                    <form class = "settings-form" name = "f-add-emplacement-article-par-reference" id = "f-add-emplacement-article-par-reference" method = "post" action = "{{url('/creer-emplacement-article-par-reference')}}" onsubmit = "validerCreationEmplacement()">
                                        @csrf
                                                    ...
                                                    <div class = "item-data">
                                                        <select class = "form-control" name = "article" id = "article" onchange = "effacerErreurArticle()" required>
                                                            ...
                                                            @if(!empty($liste_article))
                                                                @foreach ($liste_article as $data)
                                                                    <option value = "{{$data->getReferenceArticleAttribute()}}">{{$data->getDesignationArticleAttribute()}}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
                                        ...
                                        <p class = "form-text text-danger" id = "erreur_article"></p>
                                        <div class = "item py-3">
                                            <div class = "row justify-content-between align-items-center">
                                                <div class = "col-auto col-lg-6">
                                                    <div class = "item-label">

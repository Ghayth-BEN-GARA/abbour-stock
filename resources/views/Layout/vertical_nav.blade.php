        ...
        <ul class = "app-menu list-unstyled accordion" id = "menu-accordion">
            ...
            @if (session('type') != 'Utilisateur')
                ...
                <li class = "nav-item has-submenu">
                    ...
                    <div id = "submenu-2" class = "collapse submenu submenu-2" data-bs-parent = "#menu-accordion">
                        <ul class = "submenu-list list-unstyled">
                            <li class = "submenu-item">
                                <a class = "submenu-link" href = "{{url('/add-fournisseur')}}">Créer</a>
                            </li>
                            <li class = "submenu-item">
                                <a class = "submenu-link" href = "{{url('/liste-fournisseurs')}}">Gérer</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class = "nav-item has-submenu">
                    ...
                    <div id = "submenu-3" class = "collapse submenu submenu-2" data-bs-parent = "#menu-accordion">
                        <ul class = "submenu-list list-unstyled">
                            ...
                            <li class = "submenu-item">
                                <a class = "submenu-link" href = "{{url('/liste-factures-achats')}}">Gérer</a>
                            </li>
                            <li class = "submenu-item">
                ...
                <li class = "nav-item has-submenu">
                    <a class = "nav-link submenu-toggle" href = "javascript:void(0)" data-bs-toggle = "collapse" data-bs-target = "#submenu-4" aria-expanded = "false" aria-controls = "submenu-4">
                        ...
                        <span class = "nav-link-text">Réglements (Achats)</span>
                        <span class = "submenu-arrow">
		                    <svg width = "1em" height = "1em" viewBox = "0 0 16 16" class = "bi bi-chevron-down" fill = "currentColor" xmlns = "http://www.w3.org/2000/svg">
	                            <path fill-rule = "evenodd" d = "M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
	                        </svg>
                    ...
                    <div id = "submenu-4" class = "collapse submenu submenu-2" data-bs-parent = "#menu-accordion">
                        <ul class = "submenu-list list-unstyled">
                            <li class = "submenu-item">
                                <a class = "submenu-link" href = "{{url('/creer-reglement-achat-libre')}}">Créer un réglement libre</a>
                            </li>
                            <li class = "submenu-item">
                                <a class = "submenu-link" href = "{{url('/liste-reglements-achats')}}">Gérer</a>
                            </li>
                        </ul>
                    </div>
                </li>
            ...
            <li class = "nav-item has-submenu">
                ...
                <div id = "submenu-5" class = "collapse submenu submenu-2" data-bs-parent = "#menu-accordion">
                    <ul class = "submenu-list list-unstyled">
                        <li class = "submenu-item">
                            <a class = "submenu-link" href = "{{url('/caisse')}}">Caisse</a>
                        </li>
                        <li class = "submenu-item">
                            <a class = "submenu-link" href = "{{url('/liste-factures-ventes')}}">Gérer</a>
                        </li>
                    </ul>
                </div>
            </li>
            <li class = "nav-item has-submenu">
                    <a class = "nav-link submenu-toggle" href = "javascript:void(0)" data-bs-toggle = "collapse" data-bs-target = "#submenu-9" aria-expanded = "false" aria-controls = "submenu-9">
                        <span class = "nav-icon">
                            <i class = "lni lni-credit-cards"></i>
                        </span>
                        <span class = "nav-link-text">Réglements (Ventes)</span>
                        <span class = "submenu-arrow">
		                    <svg width = "1em" height = "1em" viewBox = "0 0 16 16" class = "bi bi-chevron-down" fill = "currentColor" xmlns = "http://www.w3.org/2000/svg">
	                            <path fill-rule = "evenodd" d = "M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
	                        </svg>

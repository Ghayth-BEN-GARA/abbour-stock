            ...
            <div class = "col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
                <div class = "d-flex flex-column align-content-end">
                    <div class = "app-auth-body mx-auto">
                        ...
                        <h2 class = "auth-heading text-center mb-5">Réinitialiser le mot de passe</h2>
                        <div class = "auth-intro mb-4 text-center">
                            Entrez votre adresse e-mail ci-dessous. Nous vous enverrons par e-mail un lien vers une page où vous pourrez facilement créer un nouveau mot de passe.
                        </div>
                        <div class = "auth-form-container text-left">
                            ...
                            @endif
                            <form class = "auth-form resetpass-form" name = "f" id = "f" action = "{{url('/chercher-compte')}}" method = "post">
                                @csrf
                                <div class = "email mb-3">
                                    <label class = "mx-1">Adresse email</label>
                                    <input id = "email" name = "email" type = "email" class = "form-control login-email" placeholder = "Entrez votre adresse email.." required>
                                </div>
                            ...
                            <div class = "auth-option text-center pt-5">
                                <a class = "app-link" href = "{{url('/')}}" >Connexion</a>
                                <span class = "px-2">|</span>
                                <a class = "app-link" href = "{{url('/signup')}}" >Inscription</a>
                            </div>
                        </div>
                    </div>

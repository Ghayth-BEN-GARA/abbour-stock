...
<html lang = "en"> 
    <head>
        <title>Abbour'Stock Dépôt | Meilleur prix</title> 
                ...
                <div class = "app-content pt-3 p-md-3 p-lg-4">
                    <div class = "container-xl">
                        <div class = "row g-3 mb-4 align-items-center justify-content-between">
                            <div class = "col-auto">
			                    <h1 class = "app-page-title mb-0">Meilleur prix</h1>
				            </div>
                        </div>
                                            ...
                                            <table class = "table table-bordered mb-0 text-left">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class = "cell">Prix d'chat</th>
                                                        <th class = "cell">Fournisser</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @if(empty($article))
                                                    ...
                                                    @else
                                                        @foreach($fournisseur as $data)
                                                            <tr>
                                                                ...
                                                                <td class = "cell">
                                                                    <p>
                                                                        {{str_replace( ',', '',number_format($data->prix_unitaire_article, 3))}} DT
                                                                    </p>
                                                                </td>
                                                                <td class = "cell">
                                                                    <p>

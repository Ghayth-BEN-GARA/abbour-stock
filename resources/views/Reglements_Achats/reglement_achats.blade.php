                ...
                <div class = "container-xl">
                    ...
                    @if(empty($fournisseur))
                        <div class="alert alert-warning d-flex align-items-center" role = "alert">
                            ...
                            <div class = "mx-2">
                                Aucun réglement avec cette matricule fiscale actuellement trouvé.
                            </div>
                        </div>
                    @else
                        <div class = "all_page p-2">
                            <div class = "main-wrapper">
                                <div class = "main-content">
                                        ...
                                        <div class = "item active">
                                            ...
                                            <div class = "info">
                                                <div class = "card-info">
                                                    ...
                                                    <div class = "number">{{$fournisseur->getMatriculeFournisseurAttribute()}}</div>
                                                </div>
                                            ...
                                            <div class = "card-bottom">
                                                <div class = "name">{{$fournisseur->getFullNameFournisseurAttribute()}}</div>
                                                <div class = "date">
                                        ...
                                        <div class = "row">
                                            <div class = "col-md-4 mb-4 stretch-card transparent">
                                                <div class = "card card-tale">
                                                    <div class = "card-body">
                                                        <p class = "mb-1 h5 text-white">Net</p>
                                                        <p class = "fs-30 mb-3">{{number_format($net_reglement, 3)}} DT</p>
                                                        <p class = "text-capitalize mb-0">
                                                            <?php
                                                                setlocale (LC_TIME, 'fr_FR.utf8','fra');
                                                                echo strftime("%A %d %B %Y",strtotime(strftime($dernier_date_reglement)))  
                                                            ?>
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class = "col-md-4 mb-4 stretch-card transparent">
                                                <div class = "card card-dark-blue">
                                                    <div class = "card-body">
                                                        ...
                                                        <p class = "fs-30 mb-3">{{number_format($paye_reglement, 3)}} DT</p>
                                                        <p class = "text-capitalize mb-0">
                                                            <?php
                                                                setlocale (LC_TIME, 'fr_FR.utf8','fra');
                                                                echo strftime("%A %d %B %Y",strtotime(strftime($dernier_date_reglement)))  
                                            ...
                                            <div class = "col-md-4 mb-4 stretch-card transparent">
                                                <div class = "card card-light-blue">
                                                    <div class = "card-body">
                                                        ...
                                                        <p class = "fs-30 mb-3">{{number_format($net_reglement - $paye_reglement, 3)}} DT</p>
                                                        <p class = "text-capitalize mb-0">
                                                            <?php
                                                                setlocale (LC_TIME, 'fr_FR.utf8','fra');
                                                                echo strftime("%A %d %B %Y",strtotime(strftime($dernier_date_reglement)))  
                                    ...
                                    @livewire('liste-reglements-achats-fournisseurs', ['matricule_fournisseur' => $fournisseur->matricule_fournisseur]) 
                                </div>
                                <div class = "main-sidebar">
                                    <div class = "box">
                                        <div class = "user">
                                            ...
                                            <div class = "name">{{$fournisseur->getFullNameFournisseurAttribute()}}</div>
                                            <div class = "date text-desc">{{$fournisseur->getMatriculeFournisseurAttribute()}}</div>
                                        </div>
                                        <div class = "divider-gray"></div>
                                        <div class = "card-info-box">
                                            <div class = "text-desc">Net</div>
                                            <div class = "number">{{number_format($net_reglement, 3)}} DT</div>
                                            <div class = "text-desc">Payé {{number_format($paye_reglement, 3)}} DT</div>
                                        </div>
                                        <div class = "divider-gray"></div>
                                                ...
                                                <div class = "inner">
                                                    ...
                                                    <div class = "text-content">
                                                        ...
                                                        <p class = "text-capitalize">   Debut :
                                                            <?php
                                                                setlocale (LC_TIME, 'fr_FR.utf8','fra');
                                                                echo strftime("%A %d %B %Y",strtotime(strftime($date_debut_reglement)))  
                                                            ?>
                                                        </p>

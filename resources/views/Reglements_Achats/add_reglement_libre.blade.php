                        ...
                        <div class = "col-12 col-lg-12">
                            <div class = "app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                                ...
                                <div class = "app-card-body px-4 w-100">
                                    <form class = "settings-form" name = "f-create-reglement" id = "f-create-reglement" method = "post" action = "{{url('/create-reglement-achat-libre')}}" onsubmit = "validerFormulaireCreerPaiementLibre()">
                                        @csrf
                                        ...
                                        <div class = "item border-bottom py-3">
                                            <div class = "row justify-content-between align-items-center">
                                                <div class = "col-auto col-lg-6">
                                                    ...
                                                    <div class = "item-data">
                                                        <select class = "form-control" id = "fournisseur" name = "fournisseur" required onchange = "effacerErreurFournisseurReglement()">
                                        ...
                                        <p class = "form-text text-danger" id = "erreur_fournisseur"></p>
                                        <div class = "item py-3">
                                            <div class = "row justify-content-between align-items-center">
                                                <div class = "col-auto col-lg-6">
                                                    <div class = "item-label">

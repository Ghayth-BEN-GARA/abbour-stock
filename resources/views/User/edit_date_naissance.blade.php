...
<html lang = "en"> 
    <head>
        <title>Abbour'Stock Dépôt | Modifier le date de naissance</title> 
                ...
                <div class = "container-xl">
                    ...
                    <div class = "row g-4 settings-section">
                        <div class = "col-12 col-md-4">
                            <h3 class = "section-title">Date de naissance</h3>
                            <div class = "section-intro">
                                Modifiez votre date de naissance enregistrés dans l'application Abbour'Stock Dépôt.
                            </div>
                        </div>
                        <div class = "col-12 col-md-8">
                            <div class = "app-card app-card-settings shadow-sm p-4">
                                <div class = "app-card-body">
                                    <form class = "settings-form" name = "f" id = "f" method = "post" action = "{{url('/update-date-naissance')}}">
                                        @csrf

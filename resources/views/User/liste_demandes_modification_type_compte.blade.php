                            ...
                            <div class = "app-card app-card-notification shadow-sm mb-4">
                                ...
                                <div class = "app-card-body p-4">
                                    <div class = "notification-content">
                                        L'utilisateur {{$data->prenom}} {{$data->nom}} vous a envoyé une demande de changement de type de compte pour changer le type de son compte de <b>{{$data->type}}</b> à <b>{{$data->getTypeDemandeAttribute()}}</b>. Vous pouvez voir les informations de demande ici.
                                    </div>
                                </div>
                                @if($data->getEtatDemandeAttribute() == 0)
                                    <div class = "app-card-footer px-4 py-3">
                                        <a class = "action-link mx-2" href = "{{url('/gestion-modifier-etat-demande?id_demande='.$data->getIdDemandeAttribute().'&resp=1&id_user='.$data->id_user)}}" style = "color:inherit">
                                            Accepter la demande <i class = "lni lni-checkmark-circle"></i>
                                        </a>
                                        <a class = "action-link" href = "{{url('/gestion-modifier-etat-demande?id_demande='.$data->getIdDemandeAttribute().'&resp=-1&id_user='.$data->id_user)}}" style = "color:inherit">
